...
import { obtenerdetallesposicionesFinalesAction } from '../../action/resultadoAction';
...
const ModalFinales = (props) => {
  ...
  const obtenerdetallesposiciones = (id)=>dispatch(obtenerdetallesposicionesFinalesAction(id));
  const detallesposiciones = useSelector(state =>state.resultado.detallesposicionesfinales);
        ...
        <DialogContent dividers>
            <Table aria-label="customized table">
              ...
              <TableBody>
              {
                  ...
                  (
                  <TableRow>
                      <StyledTableCell colSpan={8}>No hay registro aún.</StyledTableCell>
                  </TableRow>
                  )
                  :
                  ...
                  <StyledTableRow key={ row.id_partido }>
                    ...
                    <StyledTableCell align='center'>{ row.ganador_penales || " - " }</StyledTableCell>
                    <StyledTableCell align='center'>{ row.ganador_penales_fifa || " - " }</StyledTableCell>
