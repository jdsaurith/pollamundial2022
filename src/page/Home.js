...
import CuartosSemiFinal from '../component/octavos/CuartosSemiFinal';
  ...
  const btnInfoNoSave = () =>{
    setDatos({
      ...
      contenido: `Puedes guardar el resultado en cualqueir momento,
                  siempre y cuando sea antes del inicio del partido :).`
    });
    setOpenModal(true);
  }
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Box component="main" sx={{ flex: 1, py: componente === 'Reglas' ? 3 : 6, px: componente === 'Usuarios' ? 3 : 1, bgcolor: '#eaeff1' }}>
           <Contenedor>
                  ...
                  {componente === 'Agregar Fechas' && <CuartosSemiFinal  />}
                  {componente === 'FECHA 1' && 
                  <>
